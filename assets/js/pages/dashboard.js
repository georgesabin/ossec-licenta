    ...
    $.ajax({
      ...
      if(typeof result.Vitals !== 'undefined') {
        ...
        if(cpuLoadsAvg.length == 3) {
          ...
          if(!$('*[data-name="cpu_1min_bar"]').hasClass(cpu1MinColor)) { $('*[data-name="cpu_1min_bar"]').removeClass('progress-bar-success').removeClass('progress-bar-info').removeClass('progress-bar-warning').removeClass('progress-bar-danger').addClass(cpu1MinColor); }
          ...
          if(!$('*[data-name="cpu_5min_bar"]').hasClass(cpu5MinColor)) { $('*[data-name="cpu_5min_bar"]').removeClass('progress-bar-success').removeClass('progress-bar-info').removeClass('progress-bar-warning').removeClass('progress-bar-danger').addClass(cpu5MinColor); }
          ...
          if(!$('*[data-name="cpu_15min_bar"]').hasClass(cpu15MinColor)) { $('*[data-name="cpu_15min_bar"]').removeClass('progress-bar-success').removeClass('progress-bar-info').removeClass('progress-bar-warning').removeClass('progress-bar-danger').addClass(cpu15MinColor); }
        ...
        if(!$('*[data-name="disk_used_bar"]').hasClass(diskUsedColor)) { $('*[data-name="disk_used_bar"]').removeClass('progress-bar-success').removeClass('progress-bar-info').removeClass('progress-bar-warning').removeClass('progress-bar-danger').addClass(diskUsedColor); }
